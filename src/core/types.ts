...
export interface CommandOptions {
  ...
  webOut?: string;
  webPort?: number;
  ingestAction?: "plan" | "status" | "mark" | "validate" | "import-extractors" | "converters-status";
  ...
  ingestReason?: string;
  ingestFile?: string;
  ingestConvert?: boolean;
  ingestConverter?: "marker";
  ingestConversionWorkers?: number;
  ingestConversionTimeoutMs?: number;
  ingestConversionMaxMb?: number;
  hosts: HostId[];
  topicValues: string[];
